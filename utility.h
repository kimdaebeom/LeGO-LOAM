...
extern const string pointCloudTopic = "/carla/ego_vehicle/lidar/lidar/point_cloud";
extern const string imuTopic = "/carla/ego_vehicle/imu/imu/data";
...
extern const int   historyKeyframeSearchNum = 31; // 2n+1 number of hostory key frames will be fused into a submap for loop closure
extern const float historyKeyframeFitnessScore = 0.1; // the smaller the better alignment

extern const float globalMapVisualizationSearchRadius = 300.0; // key frames with in n meters will be visualized
